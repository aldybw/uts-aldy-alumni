package ac.id.pnj.utsaldyberita.fragment.profile;
...
import ac.id.pnj.utsaldyberita.HomeActivity;
import ac.id.pnj.utsaldyberita.LoginActivity;
...
public class ProfileFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        sharedPreferences = getActivity().getSharedPreferences("UtsAldyBerita", Context.MODE_PRIVATE);
